...
<body>
    ...
    <div class="images" style="display:flex;flex-wrap:wrap;width:100%; margin-top:50px;flex-direction:row !important; justify-content: center">
      ...
      <div class="goal" style="display:flex;flex-direction:rows;justify-content:space-between; margin:0px 20px 0px 20px">
          <div style="display:flex;">
                <img src="<?=$DEFAULT_PATH?>assets/images/matrics_steps.svg" style="margin-right:10px;margin-bottom:23px;">
  ...
  <div class="img "style="background: linear-gradient(206.14deg, rgba(255, 96, 145, 0.81) 0%, rgba(81, 39, 221, 0.468) 145.34%);border-radius: 20px;width: 274.26px;height: 270.88px; margin:30px 65px">
    <div class="" style="flex-direction:column;display:flex;">
      ...
      <div style="margin-top:-30px !important;">
      <div class="" style="background-image:url('<?=$DEFAULT_PATH?>assets/images/matrics_heartrate_bg.svg');background-repeat:no-repeat;background-position:center;position:relative;">
  ...
  <div class="goal" style="display:flex;flex-direction:rows;justify-content:space-between; margin:0px 20px 0px 20px">
    <div style="display:flex;">
      <img src="<?=$DEFAULT_PATH?>assets/images/matrics_heartrate.svg" style="margin-right:10px;margin-bottom:23px;">
    </div>
      <div><img src="<?=$DEFAULT_PATH?>assets/images/matrics_up.svg" style="margin-top:12px"></div>
      ...
      <div><img src="<?=$DEFAULT_PATH?>assets/images/matrics_down.svg" style="margin-top:12px"></div>
...
<div class="img "style="background: linear-gradient(208.27deg, rgba(39, 142, 255, 0.72) 41.57%, rgba(98, 113, 255, 0.416) 93.17%);border-radius: 20px;width: 274.26px;height: 270.88px;margin:30px 65px;">
  <div class="" style="flex-direction:column;display:flex;">
    <p  class="img_title">Water</p>
      <div style="margin-top:-30px !important;">
        <div class="" style="background-image:url('<?=$DEFAULT_PATH?>assets/images/matrics_water_bg.svg');background-repeat:no-repeat;background-position:center;position:relative;background-size:contain;">
      ...
      <div class="goal" style="display:flex;flex-direction:rows;justify-content:space-between; margin:0px 20px 0px 20px">
          <div style="display:flex;">
                <img src="<?=$DEFAULT_PATH?>assets/images/matrics_water.svg" style="margin-right:10px;margin-bottom:23px;">
                <p class="gl"style="color:white;">Goal</p>
          </div>
    ...
    <div class="img "style="background: linear-gradient(237.6deg, rgba(78, 205, 196, 0.468) -24.24%, rgba(85, 98, 112, 0.81) 100%);border-radius: 20px;width: 274.26px;height: 270.88px;margin:30px 65px;">
        ...
        <div style="margin-top:-30px !important;">
        <div class="" style="background-image:url('<?=$DEFAULT_PATH?>assets/images/matrics_kg_bg.svg');background-repeat:no-repeat;background-position:center;position:relative;">
        <div><img src="<?=$DEFAULT_PATH?>assets/images/Ellipse_matrics.svg" style="margin-left:69px;"></div>
        <div style="position:absolute;left: 40%;right: 33.33%;top: 6.9%;bottom: 34.83%;">
      ...
      <div class="goal" style="display:flex;flex-direction:rows;justify-content:space-between; margin:0px 20px 0px 20px">
        <div style="display:flex;">
          <img src="<?=$DEFAULT_PATH?>assets/images/matrics_kg.svg" style="margin-right:10px;margin-bottom:23px;">
          <p class="gl"style="color:white;">Goal</p>
       </div>
...
<div class="img "style="background: linear-gradient(208.27deg, rgba(69, 24, 219, 0.81) 30.7%, rgba(123, 41, 255, 0.468) 95.3%);border-radius: 20px;width: 274.26px;height: 270.88px;margin:30px 65px;">
  <div class="" style="flex-direction:column;display:flex;">
    ...
    <div class="" style="background-image:url('<?=$DEFAULT_PATH?>assets/images/matrics_sleep_bg.svg');background-repeat:no-repeat;background-position:center;position:relative;">
    <div><img src="<?=$DEFAULT_PATH?>assets/images/Ellipse_matrics.svg" style="margin-left:64px;"></div>
  ...
  <div class="goal" style="display:flex;flex-direction:rows;justify-content:space-between; margin:0px 20px 0px 20px">
    <div style="display:flex;">
      <img src="<?=$DEFAULT_PATH?>assets/images/matrics_sleep.svg" style="margin-right:10px;margin-bottom:23px;">
      <p class="gl"style="color:white;">Goal</p>
    </div>
...
<div class="img "style="background: linear-gradient(61.08deg, rgba(221, 94, 137, 0.9) 0%, rgba(247, 187, 151, 0.52) 130.74%);border-radius: 20px;width: 274.26px;height: 270.88px;margin:30px 65px;">
  <div class="" style="flex-direction:column;display:flex;">
    ...
    <div style="margin-top:-30px !important;">
    <div class="" style="background-image:url('<?=$DEFAULT_PATH?>assets/images/matrics_cal_bg.svg');background-repeat:no-repeat;background-position:center;position:relative;">
...
<div class="goal" style="display:flex;flex-direction:rows;justify-content:space-between; margin:0px 20px 0px 20px">
  <div style="display:flex;">
    <img src="<?=$DEFAULT_PATH?>assets/images/matrics_cal.svg" style="margin-right:10px;margin-bottom:23px;">
    <p class="gl"style="color:white;">Goal</p>
  </div>
