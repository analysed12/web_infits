                ...
                <div class="event-image">
                    <div class="ev-img" style="position:relative">
                        <!-- <div style="background: #7282FB;border-radius:100px;padding:0.5rem;margin-top:3rem;cursor:pointer;">
                            <img src="<?= $DEFAULT_PATH ?>assets/images/whitepencil.svg" id="firstImage"
                                class="img-change-btn" alt="editicon">
                        </div> -->
                    ...
                    <!-- <div id="imgChange">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <input type="submit" name="submit1" value="Update" class="btn btn-primary btn-xs">
                        </form>
                    </div> -->
                    <?php
                    if (isset ($_POST['submit1'])) {
                        ...
                        $folder = 'uploads/profile/images' . $img_name;
                        $img_query = mysqli_query($conn,"UPDATE `create_plan` SET `image`='$img_name' where plan_id='$id'");
                    ...
                    <script>
                        ...
                        firstImage.addEventListener('click', function () {
                            ...
                            var currentDisplay = window.getComputedStyle(imgChange).getPropertyValue('display');
                ...
                <form action="#" method="post">
                    ...
                    <div style="text-align:center !important;;margin-top:2rem;" class="plan_name_box">
                        <input required type="text" placeholder="Plan Name" class="plan_name" name="plan_name"
                            style="border:none;" value="<?php echo $row['name'] ?>"><img
                            src="<?= $DEFAULT_PATH ?>assets/images/pencil.svg" alt="">
                    </div>
                                ...
                                <div class="features_left textbox-wrapper">
                                    <div class="input-group">
                                        ...
                                        for ($a - 1; $a >= $y - 3; $a--) { ?>
                                            ...
                                            <div class="features_box"><input type="text" name="text_arr[]" value="<?php
