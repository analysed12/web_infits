...
<body>
    <div class="sidenav" id="sidenavbar">
        ...
        <a id="index" class="sidenavlink nav-index nav-task_list nav-track_stats_steps nav-track_stats_water nav-track_stats_heart nav-track_stats_sleep nav-track_stats_weight nav-track_stats_calorie" href="index.php"><img src="<?=$DEFAULT_PATH?>assets/images/dashboard.svg" class="nav-icon">Dashboard</a>
        ...
        <a id="calendar_of_events" class="sidenavlink nav-calendar_of_events" href="calendar_of_events.php"><img src="<?=$DEFAULT_PATH?>assets/images/calendar.svg" class="nav-icon">Appoinments</a>
        <a id="client_list" class="sidenavlink nav-client_list nav-client_dashboard nav-setgoals nav-set_reminders nav-mealTracker" href="client_list.php"><img src="<?=$DEFAULT_PATH?>assets/images/clients.svg" class="nav-icon">Clients</a>
        <a id="myplan" class="sidenavlink nav-myplan" href="myplan.php"><img src="<?=$DEFAULT_PATH?>assets/images/dietPlan.svg" class="nav-icon">Diet Plans</a>
        <a id="payments" class="sidenavlink nav-payments" href="billingAndInvoices.php"><img src="<?=$DEFAULT_PATH?>assets/images/payment.svg" class="nav-icon">Payments</a>
        <a id="create_recipe" class="sidenavlink nav-all_recipes nav-create_recipe" href="all_recipes.php"><img src="<?=$DEFAULT_PATH?>assets/images/recipies.svg" class="nav-icon">Recipes</a>
        <a id="healthform" class="sidenavlink nav-healthform" href="#"><img src="<?=$DEFAULT_PATH?>assets/images/healthForm.svg" class="nav-icon">Health Form</a>

        <div class="menu-bottom">
            <a class="sidenavlink nav-help" href="help.php"><img src="<?=$DEFAULT_PATH?>assets/images/getHelp.svg" class="nav-icon">Get Help</a>
            <a class="sidenavlink nav-settings" href="settings.php"><img src="<?=$DEFAULT_PATH?>assets/images/settings.svg" class="nav-icon">Settings</a>
    ...
    <div class="topnav">
        ...
        <!-- <div style="margin-right:2rem;display:flex;gap:1.5rem">
            ...
            <div class="search-box">
                <button onclick="" id="toggleSearch" style="border-style:none;background:white;"><img src="<?=$DEFAULT_PATH?>assets/images/search.svg" style="height: 20px; width: 20px;" class="sea"></button> 
            </div> 
            ...
            <img src="<?=$DEFAULT_PATH?>assets/images/dietitian_profile.svg" style="height: 24px; width: 24px" id="addusermale">
    ...
    <div class="mobile-menu">
        <div id="mySidenav" class="sidenavv">
            ...
            <a href="index.php" id="defaultOpen"><img src="<?=$DEFAULT_PATH?>assets/images/dashboard.svg">&nbsp&nbsp Dashboard</a>
