    ...
    while ($Custom_Day2 >= $Custom_Day1) {
        ...
        while ($i < $count) {
            ...
            $list .= '<div class="meal-box">
                        <div class="left">
                            <img src="<?= $DEFAULT_PATH ?>assets/images/calorie_meal_icon.svg" alt="">
...
<div class="right">
    <img src="<?= $DEFAULT_PATH ?>assets/images/calorie_fire_icon.svg" alt="">
                                    ...
                                    while ($i < $count) {
                                        ...
                                        <div class="meal-box">
                                            ...
                                            <div class="right">
                                                <img src="<?= $DEFAULT_PATH ?>assets/images/calorie_fire_icon.svg" alt="">
                                                <p class="kcal">
                                                    <?php echo ($yearly_Data[$i]['caloriesConsumed']) ?> kcal
                                                </p>
                                            </div>
                                        </div>
                                        <?php $i++;
                                    ...
                                    while ($i < $count) {
                                        ...
                                        <div class="meal-box">
                                            ...
                                            <div class="right">
                                                <img src="<?= $DEFAULT_PATH ?>assets/images/calorie_fire_icon.svg" alt="">
                                                <p class="kcal">
                                                    <?php echo ($monthly_Data[$i]['caloriesConsumed']) ?> kcal
                                                </p>
                                            </div>
                                        </div>
                                        <?php $i++;
                                    ...
                                    while ($i < $count) {
                                        ...
                                        <div class="meal-box">
                                            ...
                                            <div class="right">
                                                <img src="<?= $DEFAULT_PATH ?>assets/images/calorie_fire_icon.svg" alt="">
                                                <p class="kcal">
                                                    <?php echo ($weekly_Data[$i]['caloriesConsumed']) ?> kcal
                                                </p>
                                            </div>
                                        </div>
                                        <?php $i++;
