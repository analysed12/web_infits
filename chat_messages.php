                ...
                <div class="  d-inline-block p-2 flex-fill justify-content-between chat">
                    <div class="d-flex flex-row justify-content-between  mx-4">
                        <div class="d-flex  align-items-center  ">
                            <img src="<?=$DEFAULT_PATH?>assets/images/<?= $chatWith['p_p'] ?>" class="rounded-circle" style="width:50px">
                        ...
                        <div class="d-flex  align-items-center ">
                            <div onclick="videocall('<?= $chatWith['clientuserID'] ?>', '<?= $_SESSION['name']?>')">
                                <img class="" src="<?=$DEFAULT_PATH?>assets/icons/videocall.svg" style="width:20px;margin-right:24px; cursor: pointer;"/>
                            </div>
                            <img class=" "  src="<?=$DEFAULT_PATH?>assets/icons/vector-i.svg" style="width:20px;margin-right:5px; cursor: pointer;">
                                    ...
                                    if ($chat['from_id'] == $_SESSION['dietitian_id']) { ?>
                                        <?php if (substr($chat['message'], 0, 4) == "IMG-") { ?>
                                            ...
                                            <p class="rtext align-self-end">
                                                ...
                                                <img src="<?=$DEFAULT_PATH?>assets/images/<?= $chat['message'] ?>" style="max-width: 250px">
                    ...
                    <div class="input-group align-items-center chat-end-align ">
                        ...
                        <form id="form_input" action="assets/app/ajax/upload.php" method="post" enctype="multipart/form-data">
