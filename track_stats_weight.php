        ...
        <div class="row ts-top">
            ...
            <div class="col-lg-4 tst-right">
                <div class="set-goal">
                    ...
                    <img src="<?= $DEFAULT_PATH ?>assets/images/obesity.svg" alt="">
...
?>
            ...
            ?>
                <div class="progress-box">
                    <p><img src="<?= $DEFAULT_PATH ?>assets/images/bar-graph.svg" alt=""> Your Progress</p>
            ...
            progressPercent.style.setProperty("background",
                "conic-gradient(#D7EDEC <?php echo(100 - $progressBarData[0]['avg(weight)']) ?>% , #87A9AC 0)");
            </script>
        </div>
    </div>
    <?php
