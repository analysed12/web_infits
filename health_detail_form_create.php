...
<body>
    ...
    <div class="content">
        <div class="heading-box">
            ...
            <h1 style="">Health Details Form</h1>

            <!-- <h1 style="font-size:3.5vw">Health Details Form</h1> -->
        ...
        <div class="flex-container">
            <div class="form-container">
                ...
                <div class="form-title">
                    ...
                    <input type="text" name="formName" id="formName" placeholder="Enter form name" value="<?php if (isset($form)) {
                        echo $form['form_name'];
                    } ?>">
                </div>
                ...
                <div id="questions-container">
                    <?php if (isset($_GET['form_id'])):
                        ...
                        foreach ($form as $que): ?>
                            <div class="position-relative" data-question="<?= $que['que']; ?>"><label>
                                    <?= $que['que']; ?>
                                </label>
                                <?php if ($que['ansType'] == "checkbox") {
                                    ...
                                    foreach ($options as $key => $value):
                                        ...
                                        <input type="<?= $que['ansType']; ?>" name="<?= $value; ?>" id="<?= $value; ?>"
                                            value="<?= $value ?>" class="inputCheck">
                                        <label for="<?= $value; ?>" class="inputLabel">
                                            <?= $value; ?>
                                        </label>
                                    <?php endforeach;
                                    ...
                                    $options = $que['options'];
                                    foreach ($options as $key => $value): ?>
                                            <input type="<?= $que['ansType']; ?>" name="<?= $que['name']; ?>" id="<?= $value; ?>"
                                                value="<?= $value; ?>" class="inputradio">
                                            <label for="<?= $value; ?>" class="inputLabel">
                                            <?= $value; ?>
                                            </label>
                                    <?php endforeach;
                                ...
                                <?php }
                                ?>
                                <div class="position-absolute d-flex flex-column align-items-end" style="padding:0; width: 40px; right:10px; top:10px;box-shadow:none;">
                                    <span class="edit-icon"
                                        onclick="edit_from_db(this.parentElement, this.parentElement.children[1].type, Array.prototype.indexOf.call(this.parentElement.parentElement.children, this.parentElement))">✎</span>
                                    <span class="delete-icon" onclick="delete_from_db(this.parentElement)">&#128465;</span>
                                </div>
                            </div>
                        <?php endforeach;
                    endif; ?>
                            ...
                            while ($client = $result->fetch_assoc()) {
                                ...
                                if ($result2->num_rows < 1) { ?>
                                    <li>
                                        ...
                                        <label for="checkBox" class="userName">
                                            <?= $client['clientuserID'] ?>
                                        </label>
                                    </li>
                                    <?php
