...
<head>
    ...
    <title>Infits | Recipes_Dinner</title>
...
<body>
    ...
    if (isset($_POST['search_btn'])) {
        if (!empty($_POST['search_query'])) {
            $_SESSION['dinner_recipe_search'] = $_POST['search_query'];
    ...
    <div class="header">
        <div class="heading" style="display:flex;justify-content:space-between;margin-top:-5px">
            ...
            <h4 style="margin-left:30px;color:#787885;font-size: 23px;margin-top:1.8rem;">Dinner</h4>
        </div>
        <div class="search" style="margin-right:5rem;display:flex;gap:1.5rem">
            <div class="searchbox">
                <form method="post">
                    ...
                    <input type="search" name="search_query" placeholder="Search" style="outline:none;border:none;font-size:20px;margin-left:1rem;width:200px;" value="<?php if (!empty($dinnerRecipeSearch)) {
    ...
    <div class="middle_wrapper" style="display:flex;justify-content:space-between;margin-top:20px;margin-left:5rem;margin-right:2.5rem">
        ...
        <a href="recipe_all_dinner.php" style="text-decoration:none;">
    ...
    $sql2 = "SELECT dr.* FROM `default_recipes` dr LEFT JOIN `updated_by_users` ubu ON dr.`drecipe_id` = ubu.`updated_drecipe_id`AND ubu.`dietitian_id`='{$_SESSION['dietitian_id']}' WHERE ubu.`updated_drecipe_id` IS NULL AND ubu.`dietitian_id` IS NULL AND drecipe_course LIKE 'dinner'";
        ...
        ?>
            <div class="card d-flex" style="padding:15px; width:330px; height:220px;border-radius:16px; margin:25px 20px 25px 50px;">
                <div class="card-upper d-flex justify-content-between">
                    ...
                    <p id="bu" class="card-upper-text d-flex" style="margin-left:78px;"><img src="<?= $DEFAULT_PATH ?>assets/images/Clock.svg" style="margin-right:10px"></i> <?php echo $d['recipe_time']; ?> </p>
                </div>
                <div class="img-dis" style="width:100%; text-align:center;">
                    ...
                    <img src="<?= $imgSrc ?>" style="margin-top:-50px;height:101px; width:145px; margin-left:-5px; object-fit:cover;" />
                </div>
        ...
        ?>
            <div class="card d-flex" style="padding:15px; width:330px; height:220px;border-radius:16px; margin:25px 20px 25px 50px;">
                <div class="card-upper d-flex justify-content-between">
                    ...
                    <p id="bu" class="card-upper-text d-flex" style="margin-left:78px;"><img src="<?= $DEFAULT_PATH ?>assets/images/Clock.svg" style="margin-right:10px"></i> <?php echo $d['drecipe_time']; ?> </p>
                </div>
                <div class="img-dis" style="width:100%; text-align:center;">
