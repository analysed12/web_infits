    ...
    <div class="flex row">
        ...
        ?>
            <div class="card d-flex" style="padding:15px; width:310px; height:238px;border-radius:16px; margin:35px 35px;">
                ...
                <div class="img-dis" style="width:100%; text-align:center;">
                    ...
                    <img src="<?= $imgSrc ?>" style="margin-top:-10px;height:116px; width:160px; margin-left:-5px; object-fit:cover;" />
                </div>
        ...
        ?>
            <div class="card d-flex" style="padding:15px; width:310px; height:238px;border-radius:16px; margin:35px 35px;">
                ...
                <div class="img-dis" style="width:100%; text-align:center;">
                    <img src="<?= $DEFAULT_PATH ?>assets/images/Dinner.svg" style="margin-top:-10px;height:116px; width:160px; margin-left:-5px; object-fit:cover;" />
                </div>
                <div class="d-flex justify-content-between">
