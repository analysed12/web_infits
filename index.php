                ...
                for ($i = 0; $i < $lim; $i++) {
                    ...
                    <div class="container4_wrapper2">
                        ...
                        <div class="values-container col-12">
                            <span class="col-2"><a href="track_stats_steps.php?id=<?php echo ($data[$i]['client_id']) ?>"
                                    class="values"><?php echo ($infom['steps']['progress'] . '/' . $infom['steps']['goal']) ?></a></span>
                            <span class="col-2"><a href="track_stats_heart.php?id=<?php echo ($data[$i]['client_id']) ?>"
                                    class="values"><?php echo ($infom['heart']['progress']) ?> Bpm</a></span>
                            <span class="col-2"><a href="track_stats_water.php?id=<?php echo ($data[$i]['client_id']) ?>"
                                    class="values"><?php echo ($infom['water']['progress'] . '/' . $infom['water']['goal']) ?>
                                    ltrs</a></span>
                            <span class="col-2"><a href="track_stats_sleep.php?id=<?php echo ($data[$i]['client_id']) ?>"
                                    class="values"><?php echo (round($infom['sleep']['progress'], 2) . '/' . $infom['sleep']['goal']) ?>
                                    hrs.</a></span>
                            <span class="col-2"><a href="track_stats_weight.php?id=<?php echo ($data[$i]['client_id']) ?>"
                                    class="values"><?php echo ($infom['weight']['progress'] . '/' . $infom['weight']['goal']) ?>
                                    kg</a></span>
                            <span class="col-2"><a href="track_stats_calorie.php?id=<?php echo ($data[$i]['client_id']) ?>"
                        ...
                        <div class="mob_wrapper1">
                            ...
                            <div class="row1" style="display:flex ; gap:2rem;justify-content:center ">
                                ...
                                <div class="steps">
                                    ...
                                    <span class="symbols2" style="font-size:0.9rem;color:#454545"><?php echo ($infom['heart']['progress']) ?>
                                        bpm</span>
                                </div>
                            </div>
                            ...
                            <div class="row2" style="display:flex ; gap:2rem;justify-content:center">
                                <div class="steps">
                                    ...
                                    <span class="symbols3" style="font-size:0.9rem;color:#454545"><?php echo ($infom['water']['progress'] . '/' . $infom['water']['goal']) ?>
                                        ltrs</span>
                                </div>
                                <div class="steps">
                                    <div class="symbols">
                            ...
                            <div class="row3" style="display:flex ; gap:2rem;justify-content:center">
                                <div class="steps">
                                    ...
                                    <span class="symbols5" style="font-size:0.9rem;color:#454545"><?php echo ($infom['weight']['progress'] . '/' . $infom['weight']['goal']) ?>
                                        kg</span>
                                </div>
                                <div class="steps">
                                    <div class="symbols">
                                    ...
                                    <span class="symbols6" style="font-size:0.9rem;color:#454545"><?php echo ($infom['calorie']['progress'] . '/' . $infom['calorie']['goal']) ?>
                                        kcal</span>
                                </div>
                            </div>
                        </div>
