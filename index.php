    ...
    <div class="dashboard">
        ...
        <div class="dashboard_comtainer1">
            ...
            <div class="container2_rightside" >
                ...
                <div id="icon-top" class="top-icon"><div id="icon" class="plus-icon"></div></div>
                <script>
...
?>
    <div class="mobileview_clientprogress">
        ...
        <div class="mob_wrapper1" >
            <span class="up"><a href="" style=" color:black;font-weight:500; border:none; margin-top:1rem;background-color:white; margin-left:1rem"><span><img src="<?=$DEFAULT_PATH?>assets/images/ronald.svg" style="width:2rem;border-radius:1rem"> <?php echo($data[$i]['name']) ?></span></a></span>
                        ...
                        foreach ($conversations as $conversation) { ?>
                            <li class="list-group-item">
                                <a href="chat_messages.php?user=<?= $conversation['dietitianuserID'] ?>" style="display: flex !important;align-items: center !important;justify-content: space-between ;">
                                    <div class="d-flex
	    					            align-items-center">
                                        <img src="<?=$DEFAULT_PATH?>assets/images/<?= $conversation['p_p'] ?>" class="rounded-circle" style="width:40px">
