...
if (isset($_POST['update'])) {
   ...
   $result_update = mysqli_query($conn, $sql3);
    if ($result_update) {
        $sql2="INSERT INTO notification (dieticianID, dietitianuserID, ttl, body) VALUES('".$_SESSION['dietitian_id']."', '".$_SESSION['dietitianuserID']."', 'Profile Update', 'You Updated ".$name." Profile now.')";
