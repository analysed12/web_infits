    ...
    <script>
        ...
        `;
            ...
            $.ajax({
                ...
                data: {
                    ...
                    dietitianuserID: '<?php echo ($dietitianuserID) ?>',
        ...
        `;
            ...
            $.ajax({
                ...
                data: {
                    sidebarselection: true,
                    client_id: client.nextElementSibling.innerText,
                    dietitianuserID: '<?php echo ($dietitianuserID) ?>',
                    water_interval: null,
                    water_amount: null
                },
        ...
        `;
            ...
            $.ajax({
                ...
                data: {
                    ...
                    client_id: client.value,
                    dietitianuserID: '<?php echo ($dietitianuserID) ?>',
                    bf_time: bf_time.value,
                    lunch_time: lunch_time.value,
        ...
        function submitForm_water(selected, interval, amount) {
            ...
            $.ajax({
                ...
                data: {
                    update_all: true,
                    client_id: getSelectedClients(selected),
                    dietitianuserID: '<?php echo ($dietitianuserID) ?>',
