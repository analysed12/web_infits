  ...
  <div class="main">
    <div> 
      <div class="flex">
        ...
        <div class="right" style="margin-top:0.6rem">Ronald Richards</div> 
      </div>
      ...
      <div class="maindiv">
       ...
       <div class="items">
        ...
        <a class="butt" href="dietchart1.php" style="text-decoration:none;border-radius:50%;background-color:#9C74F5;
