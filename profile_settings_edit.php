        ...
        <div class="maincontainer_wrapper">
            ...
            <span style="display:flex;flex-direction:column">
                ...
                <span style="display:flex;flex-direction:column" >
                   ...
                   <span style="font-size:15px;display:flex;justify-content:space-between;text-decoration:none"><a href="forgot_password.php">Change Paswword</a> <a href="forgot_password.php">Forget Password</a></span>
                </span>
