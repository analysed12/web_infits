        ...
        <form class="maincontainer_wrapper" id="maincontainer_wrapper" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
            <div class="leftside" style="display:flex;flex-direction:column;gap:1rem">
                ...
                <span style="display:flex;flex-direction:column">
                    <span>
                        Password
                        <span style="display:flex;align-items:center;justify-content:space-between " class="input_field"><input disabled type="password" id="password" placeholder="XXXXX" value="<?= $data['password']; ?>" style="border:none;" required>
            ...
            <div class="middle" style="display:flex;flex-direction:column;gap:1rem">
                ...
                <span style="display:flex;flex-direction:column">
                    Refferal Code <input type="text" class="input_field" placeholder="XXXXX" <?php if ($data['referral_code'] == "") {
                                                                                                    echo 'name="referral_code"';
                                                                                                } else {
                                                                                                    echo 'readonly';
                                                                                                } ?> value="<?= $data['referral_code'] ?>" required>
                </span>
            ...
            <div class="rightside" style="display:flex;flex-direction:column;justify-content:center;align-items:center;gap:2rem">
                <div class="profiles" style="display:flex;flex-direction:column;position:relative; width:fit-content;">
                    <img class="profile_image" src="<?php if ($data['p_p'] !== 'user-default.png') {
                                                        echo 'uploads/profile/images/' . $data['p_p'];
                                                    } else {
                                                        echo $DEFAULT_PATH . 'assets/images/' . $data['p_p'];
                                                    } ?>" style="height: 150px !important; width: 150px !important; border-radius: 25px;z-index:-1;" alt="">
                ...
                <button type="button" id="myBtn" style="border:none; background:none; padding: 5px 60px; background-color: #0177FD; color: white; border-radius: 5px; cursor: pointer; transition: background-color 0.3s ease;">
                    <img src="<?= $DEFAULT_PATH ?>assets/images/edit.svg" style="filter: invert(1);"> <!-- Apply filter to make icon white -->
                </button>
            </div>
        </form>
        <div class="footer">
