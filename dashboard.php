    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link btn color_shadow" style="margin: 0rem 0.7rem; margin-right: 1.5rem;" href="./login.php">SignIn/SignUp</a>
          </li>
        </ul>
      </div>
    </div>
          ...
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            <ul class="navbar-nav ms-auto px-2 ps-4">
              ...
              <li class="nav-item mt-3">
                <a class="nav-link btn color_shadow" style="padding: 3px 15px;" href="./login.php">SignIn/SignUp</a>
              </li>
            </ul>
        </div>
      </div>
