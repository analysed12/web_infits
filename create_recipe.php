...
<body>
        ...
        <div id="content" class="container-fluid">
            ...
            <div class="ctop">
                <div class="left uploadImg">
                    ...
                    <?php } else { ?>
                    <img src="<?= $DEFAULT_PATH ?>assets/images/camera.svg" alt="" id="camera"
                        style="width:200px;height:170px;border-radius:20px;">
                    <?php } ?>
                    <input data-name="recipeImage" type="file" class="form-control" id="recipeImg" style="display:none"
                ...
                <div class="rtab-content-group">
                    <div class="rtab-content details-tab">
                        <div class="d-flex align-items-center justify-content-center flex-column gap-3">
                            <div class="row w-100">
                                ...
                                <div class="col dropdown-container">
                                    <select data-validate name="courses" id="recipeCourse"
                                        class="form-control input_bar" style="color: #212529 !important"
                                        placeholder="Courses">
                                        <?php
                                        $courseOptions = array(
                                            "Courses" => "Courses",
                            ...
                            <div class="row w-100">
                                <div class="col dropdown-container ">
                                    <select data-name="recipeCategory" name="category" id="recipeCategory"
                                        class="form-control input_bar" style="color: #212529 !important"
                                ...
                                <div class="col">
                                    <input data-name="recipePrepTime" required name="Preparationtime"
                                        class="form-control input_bar" type="text" class="form-control"
                            ...
                            <div class="row w-75">
                                <div class="col">
                                    <input data-nutri="Calories" required name="Calories" class="form-control input_bar"
                                        type="text" class="form-control" placeholder="Calories"
                                        value="<?php if ($action == 'editRecipe') {
                                                                                                                                                                                            echo $edit['nutritional']['Calories'];
                                                                                                                                                                                        } ?>">
                                </div>
                                <div class="col">
                                    <input data-nutri="Protein (g)" required name="Protien"
                                        class="form-control input_bar" type="text" class="form-control"
                                        value="<?php if ($action == 'editRecipe') {
                        ...
                        <div class="add-actions">
                            ...
                            <div class="add-video">
                                <button style="background:none;border:none;text-decoration:none" id="url_button">
                                    <div class="upload-url"><img src="<?= $DEFAULT_PATH ?>assets/images/Upload_Url.svg"
                                            alt="" srcset="" style="margin-right:0.5rem"><span>Upload URL</span></div>
                                </button>
                            </div>
                        </div>
                    ...
                    <form action="">
                        <div class="input-group">
                            ...
                            <select id="measurementUnit" class="ingredient_select">
                                <option style="" value="grams">Gram</option>
    ...
    function add_video() {
        ...
        const directionsList = document.getElementById(
            "direcions"); // Note: "direcions" is a typo, should be "directions"
        if (directionsList) {
    ...
    submit_btn.addEventListener('click', () => {
        ...
        form.append(
            `<input type="hidden" name="recipeingredients" value='${JSON.stringify(ingredientArray)}'>`);
