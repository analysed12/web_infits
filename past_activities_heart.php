    ...
    while ($Custom_Day2 >= $Custom_Day1) {
        ...
        while ($i < $count) {
            ...
            $list .= '<div class="meal-box">
                        <div class="left">
                            <img src="<?= $DEFAULT_PATH ?>assets/images/cycling_heart_rate.svg" alt="">
...
<div class="right">
    <img src="<?= $DEFAULT_PATH ?>assets/images/heartrate_selected_small.svg" alt="">
...
<body>
            ...
            <div class="col-sm-4 ph-right">
                ...
                <a href="track_stats_heart.php?client_id=<?php echo ($clientId) ?>">
                    <div class="client-card client-card-heart " style="color:#E3738D; border: 1px solid #E3738D;">
                        <img src="<?= $DEFAULT_PATH ?>assets/images/heartrate_selected.svg" alt="">
                        <p>Heart<br>Rate</p>
                    </div>
                </a>
            </div>
                                    ...
                                    while ($i < $count) {
                                        ...
                                        <div class="meal-box">
                                            <div class="left">
                                                ...
                                                <div class="meal-title">
                                                    <p>Max
                                                        <?php echo ($yearly_Data[$i]['maximum']) ?>
                                                    </p>
                                                    <span>
                                            ...
                                            <div class="right">
                                                <img src="<?= $DEFAULT_PATH ?>assets/images/heartrate_selected_small.svg"
                                                    alt="">
                                                <p class="kcal">
                                                    <?php echo ($yearly_Data[$i]['average']) ?> BPM
                                                </p>
                                            </div>
                                        </div>
                                        <?php $i++;
                                    ...
                                    while ($i < $count) {
                                        ...
                                        <div class="meal-box">
                                            <div class="left">
                                                ...
                                                <div class="meal-title">
                                                    <p>Max
                                                        <?php echo ($monthly_Data[$i]['maximum']) ?>
                                                    </p>
                                                    <span>
                                            ...
                                            <div class="right">
                                                <img src="<?= $DEFAULT_PATH ?>assets/images/heartrate_selected_small.svg"
                                                    alt="">
                                                <p class="kcal">
                                                    <?php echo ($monthly_Data[$i]['average']) ?> BPM
                                                </p>
                                            </div>
                                        </div>
                                        <?php $i++;
                                    ...
                                    while ($i < $count) {
                                        ...
                                        <div class="meal-box">
                                            <div class="left">
                                                ...
                                                <div class="meal-title">
                                                    <p>Max
                                                        <?php echo ($weekly_Data[$i]['maximum']) ?>
                                                    </p>
                                                    <span>
                                                        <?php echo ($I_date->format('h:i A')) ?>
                                                    </span>
                                            ...
                                            <div class="right">
                                                <img src="<?= $DEFAULT_PATH ?>assets/images/heartrate_selected_small.svg"
                                                    alt="">
                                                <p class="kcal">
                                                    <?php echo ($weekly_Data[$i]['average']) ?> BPM
                                                </p>
                                            </div>
                                        </div>
                                        <?php $i++;
    ...
    <script>
        ...
        function Custom_Data(dates) {
            $.ajax({
                type: "POST",
                url: "past_activities_heart.php?client_id=<?php echo ($clientId) ?>",
                data: {
                    dates: dates
                },
