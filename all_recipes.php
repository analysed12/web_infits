...
<body>
    ...
    <div class="main">
        ...
        while ($d = mysqli_fetch_assoc($res)) {
            ...
            $counter++;
        ?>
            <div class="card d-flex" style="padding:15px; width:310px; height:238px;border-radius:16px;margin:35px 1.5vmax;">
                <div class="card-upper d-flex justify-content-between" style="justify-content:space-between;">
                    ...
                    <p id="bu" class="card-upper-text d-flex" style="margin-left:0px; white-space: nowrap;"><img src="<?= $DEFAULT_PATH ?>assets/images/Clock.svg" style="margin-right:10px"> <?php echo $d['recipe_time']; ?> </p>
                </div>
