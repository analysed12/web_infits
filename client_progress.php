...
?>
            ...
            <div class="show" style="font-size:400">
                <span style="width: 25%;">
                <a href="" style="background-color:#FDFDFD; color:black;font-weight:400; font-size:20px; border:none; margin-top:1rem;text-decoration:none !important">
                <img src="<?=$DEFAULT_PATH?>assets/images/ronald.svg" style="width:2rem; background-color:#FDFDFD;border-radius:1rem"> <?php echo($data[$i]['name']) ?></a>
                </span>
                </div>
                <div class="values-container col-12">
                <span class="col-2" ><a style="text-decoration:none !important" href="track_stats_steps.php?id=<?php echo($data[$i]['client_id']) ?>" class="values"><?php echo($infom['steps']['progress'] . '/' . $infom['steps']['goal']) ?></a></span>
                    <span class="col-2"><a style="text-decoration:none !important" href="track_stats_heart.php?id=<?php echo($data[$i]['client_id']) ?>" class="values" ><?php echo($infom['heart']['progress']) ?> Bpm</a></span>
                    <span class="col-2"><a style="text-decoration:none !important" href="track_stats_water.php?id=<?php echo($data[$i]['client_id']) ?>" class="values" ><?php echo($infom['water']['progress'] . '/' . $infom['water']['goal']) ?> ltrs</a></span>
                    <span class="col-2"><a style="text-decoration:none !important" href="track_stats_sleep.php?id=<?php echo($data[$i]['client_id']) ?>" class="values" ><?php echo(round($infom['sleep']['progress'],2) . '/' . $infom['sleep']['goal']) ?> hrs.</a></span>
                    <span class="col-2"><a style="text-decoration:none !important" href="track_stats_weight.php?id=<?php echo($data[$i]['client_id']) ?>" class="values"><?php echo($infom['weight']['progress'] . '/' . $infom['weight']['goal']) ?> kg</a></span>
                    <span class="col-2"><a style="text-decoration:none !important" href="track_stats_calorie.php?id=<?php echo($data[$i]['client_id']) ?>" class="values" ><?php echo($infom['calorie']['progress'] . '/' . $infom['calorie']['goal']) ?> kcal</a></span>
                </div>
            </div>
<?php
    }
...
?>
        <div class="mobileview_clientprogress">
            ...
            <div class="mob_wrapper1" >
                <span style="display:flex;justify-content:center;"><a href="" style=" color:black;font-weight:500; border:none;background-color:none;text-decoration:none !important "><span ><img src="<?=$DEFAULT_PATH?>assets/images/ronald.svg" style="width:2rem;border-radius:1rem"> <?php echo($data[$i]['name']) ?></span></a></span>
                <div class="row1" style="display:flex ; justify-content:space-between">
                        <div class="steps">
                            <div class="symbols">
                            <div style="color:#F6A682"><img src="<?=$DEFAULT_PATH?>assets/images/Frame.svg" style="width:1.8rem"></div><div style="margin-top:0.2rem; font-weight:500"><span>Steps</span></div></div>
                            <span class="client_data" style="color:#454545"><?php echo($infom['steps']['progress'] . '/' . $infom['steps']['goal']) ?></span>
                        </div>
                        <div class="steps">
                            <div class="symbols">
                            <div style="color:#EF80B2"><img src="<?=$DEFAULT_PATH?>assets/images/Frame-1.svg" style="width:1.8rem"></div><div style="margin-top:0.2rem; font-weight:500"><span>Heart Rate</span></div></div>
                ...
                <div class="row2" style="display:flex; justify-content:space-between">
                        <div class="steps">
                            <div class="symbols">
                            <div style="color:#8FAFF3"><img src="<?=$DEFAULT_PATH?>assets/images/Frame-2.svg" style="width:1.8rem"></div><div style="margin-top:0.2rem; font-weight:500"><span>Water</span></div></div>
                            <span class="client_data" style="color:#454545"><?php echo($infom['water']['progress'] . '/' . $infom['water']['goal']) ?> ltrs</span>
                        </div>
                        <div class="steps">
                            <div class="symbols">
                            <div style="color:#7550E2"><img src="<?=$DEFAULT_PATH?>assets/images/Frame-3.svg" style="width:1.8rem"></div><div style="margin-top:0.2rem; font-weight:500"><span>Sleep</span></div></div>
                ...
                <div class="row3" style="display:flex ; justify-content:space-between">
                        <div class="steps">
                            <div class="symbols">
                            <div style="color:#788F96"><img src="<?=$DEFAULT_PATH?>assets/images/Frame-4.svg" style="width:1.8rem"></div><div style="margin-top:0.2rem; font-weight:500"><span>Weight</span></div></div>
                            <span class="client_data" style="color:#454545"><?php echo($infom['weight']['progress'] . '/' . $infom['weight']['goal']) ?> kg</span>
                        </div>
                        <div class="steps">
                            <div class="symbols">
                            <div style="color:#E388A0"><img src="<?=$DEFAULT_PATH?>assets/images/Frame-5.svg" style="width:1.8rem"></div><div style="margin-top:0.2rem; font-weight:500"><span>Calories</span></div></div>
