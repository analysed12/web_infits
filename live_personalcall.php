...
<body>
    <div class="live_personalcall">
        <div style="display:flex;gap:1rem"><img src="<?= $DEFAULT_PATH ?>assets/images/live-user-default.svg" style="width: 40.91px;height: 40.91px;border-radius:50%"> <span style="font-size:30px">John Wayne</span>
        </div>
        <div class="d-flex w-100 p-2 height" style="justify-content: center; ">
        ...
        <div id="myModal" class="modal">
            ...
            <div class="modal-content">
                ...
                <div class="incomingmsg">
                    <div style="display:flex;gap:1rem"><img src="<?= $DEFAULT_PATH ?>assets/images/live-user-default.svg" style="width: 35.91px;height: 35.91px;border-radius:50%"> <span style="font-size:20px;margin-top:0.2rem;">Hello !</span></div>
                ...
                <div class="outgoingmsg">
                    ...
                    <div style="display:flex;justify-content:space-between;">
                        ...
                        <div><img src="<?= $DEFAULT_PATH ?>assets/images/live-user-default.svg" style="width: 35.91px;height: 35.91px;border-radius:50%"></div>
                    </div>
                </div>
                <div class="chatmsg">
