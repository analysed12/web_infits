...
<body>
    ...
    <div class="middle_wrapper" style="display:flex;justify-content:space-between;margin-top:20px;margin-left:5rem;margin-right:2.5rem">
        ...
        <a href="recipe_all_lunch.php" style="text-decoration:none;"><h3 style="color:#6A6A6A;font-size:20px; margin-right: 50px;">View All</h3></a>
    </div>

    <!-- recipes from db -->
    <?php
    $sql = "SELECT * FROM `dietitian_recipes` WHERE dietitian_id = '{$_SESSION['dietitian_id']}' AND recipe_category = 'lunch'";
    $sql2 = "SELECT * FROM `default_recipes` WHERE drecipe_category = 'lunch';";
