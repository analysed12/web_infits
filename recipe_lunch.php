...
<body>
    <br>
    <?php 
    unset($_SESSION['lunch_recipe_search']);
    if (isset($_POST['search_btn'])) {
        if (!empty($_POST['search_query'])) {
            $_SESSION['lunch_recipe_search'] = $_POST['search_query'];
            $lunchRecipeSearch = $_POST['search_query'];
        }
    } ?>
    <div class="header">
        ...
        <div class="search" style="margin-right:5rem;display:flex;gap:1.5rem">
                ...
                <form method="post">
                    ...
                    <input type="search" name="search_query" placeholder="Search" style="outline:none;border:none;font-size:20px;margin-left:1rem;width:200px;" value="<?php  if(!empty($lunchRecipeSearch)){ echo $lunchRecipeSearch;}?>">
                    </form>
                </div>
        </div>
    </div>
    ...
    <div class="middle_wrapper" style="display:flex;justify-content:space-between;margin-top:20px;margin-left:5rem;margin-right:2.5rem">
        ...
        <a href="recipe_all_lunch.php" style="text-decoration:none;">
    ...
    if (!empty($lunchRecipeSearch)) {
        $sql .= " AND recipe_name LIKE '%$lunchRecipeSearch%'";
                    ...
                    <div class="header">
                        <div class="dropdown ">
                            ...
                            <div id="myDropdownContent" class="dropdown-content dropdown-card ">
                                <a style="color: white;" class="edit-button" href="create_recipe.php?recipe_id=<?= $d['recipe_id'] ?>&action=editRecipe&isDefault=true">Edit</a>
