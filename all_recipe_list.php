...
<body>
    <div class="header" style="align-items:center;">
        ...
        <div class="heading"
            ...
            <small
                style="color: #787885; font-size:25px; margin-left:1rem;font-family:'NATS';font-weight:400;margin-top:-10px !important;">
            ...
            <div class="searchbox" style="align-items:center;">
                <form method="post">
                    <button style="background-color:white;border:none;" id="search-btn" name="search_btn"><img
                            src="<?= $DEFAULT_PATH ?>assets/images/search_recipe.svg"></button>
                    <input type="search" name="search_query" placeholder="Search"
                        style="outline:none;border:none;font-size:20px;margin-left:1rem;font-family:'NATS';font-weight:400;margin-top:-5px;"
        ...
        <?php while ($d = mysqli_fetch_assoc($res)) {
            ...
            <div class="card d-flex" style="padding:15px; width:310px; border-radius:16px;height:238px;margin:35px 35px;">
                <div class="card-upper d-flex justify-content-between" style="white-space:nowrap ;">
                    ...
                    <p id="bu" class="card-upper-text"><i class="fa-solid fa-clock"></i>
        ...
        <?php while ($d = mysqli_fetch_assoc($res2)) {
            ...
            <div class="card d-flex" style="padding:15px; width:310px; border-radius:16px;height:238px;margin:35px 35px;">
                ...
                <div class="d-flex justify-content-between" style="margin-top:-10px;">
                    <p class="card-food ellipsis" onmouseover='toggleShowHide(stuff="",dstuff=<?= json_encode($d) ?>)'
                    ...
                    <div class="header">
                        <div class="dropdown ">
                            ...
                            <div id="myDropdownContent" class="dropdown-content dropdown-card ">
                                ...
                                <a style="color: white;" class="delete-button"
