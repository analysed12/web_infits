...
<body>
    <div class="container" style="align-items:center;margin:10px;margin-left:13rem;width:auto;">
        ...
        <a href="create_plan.php" style="text-decoration:none;display:flex !important;flex-direction:row !important;position:absolute !important;bottom:-196px;right:30px;width:270px;height:90px;background: #FFFFFF;box-shadow: 0px 5px 15px rgba(0, 0, 0, 0.25);border-radius: 50px !important;align-items:center;justify-content:center;"
            class="btns">
