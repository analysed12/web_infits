...
if (isset($_SESSION['snack_recipe_search'])) {
    $snackRecipeSearch = $_SESSION['snack_recipe_search'];
}
...
<body>
    <div class="header" style="align-items:center;">
        <div class="title" style="font-size:40px;margin-left:2.8rem;margin-top:1.2rem;font-family:'NATS'; font-weight:400;">Recipes
            <small style="color: #787885; font-size:20px; margin-left:1rem;">All Snacks Recipes</small>
        </div>
        <div style="margin-right:2rem;display:flex;gap:1.5rem">
            <div class="searchbox">
                <form method="post">
                    ...
                    <input type="search" name="search_query" placeholder="Search" style="outline:none;border:none;font-size:20px;margin-left:1rem" value="<?php if (!empty($snackRecipeSearch)) {
        ...
        ?>
            <div class="card d-flex" style="padding:15px; width:310px; border-radius:16px;height:238px;margin:35px 35px;">
                <div class="card-upper d-flex justify-content-between">
                    ...
                    <p id="bu" class="card-upper-text"><img src="<?= $DEFAULT_PATH ?>assets/images/Clock.svg" style="margin-right:10px"></i> <?php echo $d['recipe_time']; ?> </p>
                </div>
                <div class="img-dis" style="width:100%; text-align:center; margin-top: -15px;">
                    <?php if ($d['recipe_img'] != "") {
                        $imgSrc = $DEFAULT_PATH . "uploads/recipe/" . $d['recipe_img'];
                    } else {
                        $imgSrc = $DEFAULT_PATH . "assets/images/snacks.svg";
                    } ?>
                    <img src="<?= $imgSrc ?>" style="height:116px; width:160px;  object-fit:cover;" />
                </div>
                    ...
                    <div class="header">
                        <div class="dropdown ">
                            <div id="myDropdownIcon" class="dropbtn" onclick="showDropdown(event)">
                                <img class="" src="<?= $DEFAULT_PATH ?>assets/images/vertical-three-dots.svg" alt="" style="margin-top:-60px;">
                            </div>
        ...
        ?>
            <div class="card d-flex" style="padding:15px; width:310px; border-radius:16px;height:238px;margin:35px 35px;">
                <div class="card-upper d-flex justify-content-between">
                    ...
                    <p id="bu" class="card-upper-text"><img src="<?= $DEFAULT_PATH ?>assets/images/Clock.svg" style="margin-right:10px"></i> <?php echo $d['drecipe_time']; ?> </p>
                </div>
                <div class="img-dis" style="width:100%; text-align:center;margin-top:-15px">
                    <img src="<?= $DEFAULT_PATH ?>assets/images/snacks.svg" style="height:116px; width:160px;  object-fit:cover;" />
                </div>
                <div class="d-flex justify-content-between" style="margin-top:18px ;">
